# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2018-05-31 11:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('put_date', models.DateField(blank=True, null=True, verbose_name='发布日期')),
                ...
                ('attachment_path', models.CharField(blank=True, max_length=128, null=True, verbose_name='课程路径')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video_brief_link', models.CharField(blank=True, max_length=255, null=True, verbose_name='视频课程介绍')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mentor_compensation_bonus', models.PositiveIntegerField(default=15000, verbose_name='本课程的导师指导费用（贝里）')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valid_period', models.SmallIntegerField(choices=[(1, '1天'), (3, '3天'), (7, '1周'), (14, '2周'), (30, '1个月'), (60, '2个月'), (90, '3个月'), (180, '6个月'), (210, '12个月'), (540, '18个月'), (720, '24个月')], verbose_name='课程价格周期')),
                ('price', models.FloatField(verbose_name='每个周期的价格')),
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contenttypes.ContentType', verbose_name='价格关联的表名称')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('signature', models.CharField(blank=True, help_text='导师签名', max_length=64, null=True)),
